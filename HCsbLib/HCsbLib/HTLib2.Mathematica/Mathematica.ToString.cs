...
namespace HTLib2
{
	public partial class Mathematica
	{
		...
		{
			return _ToString(obj.Item1, obj.Item2);
		}
		...
		try{
			...
			if(name==typeof(Pair<int,double>                                     ).FullName) return _ToString((Pair<int,double>                                     )obj);
			...
			if(name==typeof(List<Pair<int,double>>                               ).FullName) return _ToString((List<Pair<int,double>>                               )obj);
			if(name==typeof(List<Pair<double,double>>                            ).FullName) return _ToString((List<Pair<double,double>>                            )obj);
			...
			if(name==typeof(List<double[]>                                       ).FullName) return _ToString((List<double[]>                                       )obj);
			if(name==typeof(List<double[,]>                                      ).FullName) return _ToString((List<double[,]>                                      )obj);
			if(name==typeof(MatrixByArr[]                                             ).FullName) return _ToString<MatrixByArr>((MatrixByArr[]                                             )obj);
			if(name==typeof(Vector[]                                             ).FullName) return _ToString<Vector>((Vector[]                                             )obj);
            ...
            if(name==typeof(Tuple<int   , int           >).FullName) { var val=(Tuple<int   , int           >)obj; return _ToString(val.Item1, val.Item2); }
            if(name==typeof(Tuple<int   , double        >).FullName) { var val=(Tuple<int   , double        >)obj; return _ToString(val.Item1, val.Item2); }
            if(name==typeof(Tuple<int   , double, double>).FullName) { var val=(Tuple<int   , double, double>)obj; return _ToString(val.Item1, val.Item2, val.Item3); }
            if(name==typeof(Tuple<double, double        >).FullName) { var val=(Tuple<double, double        >)obj; return _ToString(val.Item1, val.Item2); }
            if(name==typeof(Tuple<double, double, double>).FullName) { var val=(Tuple<double, double, double>)obj; return _ToString(val.Item1, val.Item2, val.Item3); }
            if(name==typeof(Tuple<double, int, int, int >).FullName) { var val=(Tuple<double, int, int, int >)obj; return _ToString(val.Item1, val.Item2, val.Item3, val.Item4); }
			if(name==typeof(Tuple<int   ,Vector         >).FullName) { var val=(Tuple<int   ,Vector         >)obj; return _ToString(val.Item1, val.Item2); }
