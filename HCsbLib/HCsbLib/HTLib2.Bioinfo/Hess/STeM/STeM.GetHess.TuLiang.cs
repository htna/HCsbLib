...
public partial class Hess
{
    public partial class STeM
    {
        ...
        public static HessMatrix GetHessCa_v2(IList<Vector> caArray)
        {
            ...
            HessMatrix hessian = HessMatrix.Zeros(caArray.Count*3, caArray.Count*3);
        ...
        public static HessMatrix GetHessCa_matlab(IList<Vector> caArray)
        {
            ...
            using(new Matlab.NamedLock("STEM"))
            {
                ...
                HessMatrix hv1 = Matlab.GetMatrix("STEM.hv1").ToHessMatrix();
                HessMatrix hv2 = Matlab.GetMatrix("STEM.hv2").ToHessMatrix();
                HessMatrix hv3 = Matlab.GetMatrix("STEM.hv3").ToHessMatrix();
                HessMatrix hv4 = Matlab.GetMatrix("STEM.hv4").ToHessMatrix();
        ...
        public static HessMatrix firstTerm(IList<Vector> caArray_, MatrixByArr distance_, int numOfResidues, FuncIJ func_K_r, HessMatrix hessian_=null)
        {
            ...
            if(hessian_ == null)
                hessian_ = HessMatrix.Zeros(caArray_.Count*3, caArray_.Count*3);
