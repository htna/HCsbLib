...
c     ################################################################
c     ##                                                            ##
c     ##  program sprshess  --  Hessian matrix test; cart. version  ##
c     ##                                                            ##
c     ################################################################
c
c
...
c
  ...
  410                format (/,' Off-diagonal sparse Hessian'
     &                         ' Indexes/Elements for Atom ',i8,1x,a1,/)
                     if (digits .ge. 10) then
                        write (ihes,415)
     &                        (hindex(k), h(k), k=hinit(j,i),hstop(j,i))
  415                   format (i8, f20.10, i8, f20.10, i8, f20.10,
     &                          i8, f20.10, i8, f20.10)
                     else if (digits .ge. 8) then
                        write (ihes,420)
     &                        (hindex(k), h(k), k=hinit(j,i),hstop(j,i))
  420                   format (i8, f16.8, i8, f16.8, i8, f16.8,
     &                          i8, f16.8, i8, f16.8)
                     else if (digits .ge. 6) then
                        write (ihes,430)
     &                        (hindex(k), h(k), k=hinit(j,i),hstop(j,i))
  430                   format (i8, f14.6, i8, f14.6, i8, f14.6,
     &                          i8, f14.6, i8, f14.6)
                     else
                        write (ihes,440)
     &                        (hindex(k), h(k), k=hinit(j,i),hstop(j,i))
  440                   format (i8, f12.4, i8, f12.4, i8, f12.4,
     &                          i8, f12.4, i8, f12.4)
                     end if
                  end if
               end do
