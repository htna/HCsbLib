...
namespace HTLib2.Bioinfo
{
	...
	{
		public static string[] GetTopologyText()
		{
			return __topology_text;
		}
		// http://www.ks.uiuc.edu/Training/Tutorials/namd/namd-tutorial-unix-html/node22.html
		public static readonly string[] __topology_text = new string[] {
			...
			,@""
			,@"PRES SHEM         0.00 ! Patch for HEME to His link."
			,@"                       ! Patch residues must be 1-CYS, and 2-HEME."
			,@"DELETE ANGLE 2NA 2FE 2NC  2NB 2FE 2ND"
			,@"BOND 1SG 2FE"
			,@"ANGLE 1CB 1SG 2FE  1SG 2FE 2NA  1SG 2FE 2NB"
			,@"ANGLE 1SG 2FE  2NC  1SG 2FE  2ND"
			,@"IC 1CB 1SG 2FE  2NA   0.0000  0.0000    0.0000  0.0000  0.0000"
			,@"IC 1CB 1SG 2FE  2NB   0.0000  0.0000    0.0000  0.0000  0.0000"
			,@"IC 1CB 1SG 2FE  2NC   0.0000  0.0000    0.0000  0.0000  0.0000"
			,@"IC 1CB 1SG 2FE  2ND   0.0000  0.0000    0.0000  0.0000  0.0000"
			,@""
			,@""
			,@""
