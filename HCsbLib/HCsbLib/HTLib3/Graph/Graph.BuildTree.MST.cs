...
namespace HTLib3
{
    public partial class Graph
    {
        ...
        {
            Debug.Assert(from.nexts.ContainsKey(to));
            return 1;
        }
        public HTLib2.Tree<Node> BuildTreeMST(Node root, Func<Node,Node,double> costfunc=null)
        {
            HTLib2.Tree<Node> tree = new HTLib2.Tree<Node>();
            ...
            while(probing.Count > 0)
            {
                ...
                Debug.Assert(double.IsNaN(cost) == false);
