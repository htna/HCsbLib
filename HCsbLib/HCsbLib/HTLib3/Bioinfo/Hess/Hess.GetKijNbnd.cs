...
namespace HTLib3
{
    public static partial class Bioinfo
    {
        ...
        {
            private class HKijFij { public double Kij, Fij; };
            private static HKijFij GetKijFijNbnd(bool vdW, bool elec
                                               ...
                                               )
            {
                ...
                ///                    epsilon = D/332
                Debug.AssertIf(elec, double.IsNaN(D) == false, double.IsInfinity(D) == false);
