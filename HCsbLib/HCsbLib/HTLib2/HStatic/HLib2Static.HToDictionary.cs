...
namespace HTLib2
{
    public static partial class HLib2Static
    {
        ...
        public static Dictionary<T1, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> HToDictionaryWithKeyItem1<T1,T2,T3,T4,T5,T6,T7,T8>(this IEnumerable<Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> list) { var dict = new Dictionary<T1, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>>(); foreach(var item in list) dict.Add(item.Item1, item); return dict; }
        public static Dictionary<T2, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> HToDictionaryWithKeyItem2<T1,T2,T3,T4,T5,T6,T7,T8>(this IEnumerable<Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> list) { var dict = new Dictionary<T2, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>>(); foreach(var item in list) dict.Add(item.Item2, item); return dict; }
        public static Dictionary<T3, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> HToDictionaryWithKeyItem3<T1,T2,T3,T4,T5,T6,T7,T8>(this IEnumerable<Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> list) { var dict = new Dictionary<T3, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>>(); foreach(var item in list) dict.Add(item.Item3, item); return dict; }
        public static Dictionary<T4, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> HToDictionaryWithKeyItem4<T1,T2,T3,T4,T5,T6,T7,T8>(this IEnumerable<Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> list) { var dict = new Dictionary<T4, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>>(); foreach(var item in list) dict.Add(item.Item4, item); return dict; }
        public static Dictionary<T5, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> HToDictionaryWithKeyItem5<T1,T2,T3,T4,T5,T6,T7,T8>(this IEnumerable<Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> list) { var dict = new Dictionary<T5, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>>(); foreach(var item in list) dict.Add(item.Item5, item); return dict; }
        public static Dictionary<T6, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> HToDictionaryWithKeyItem6<T1,T2,T3,T4,T5,T6,T7,T8>(this IEnumerable<Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> list) { var dict = new Dictionary<T6, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>>(); foreach(var item in list) dict.Add(item.Item6, item); return dict; }
        public static Dictionary<T7, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> HToDictionaryWithKeyItem7<T1,T2,T3,T4,T5,T6,T7,T8>(this IEnumerable<Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> list) { var dict = new Dictionary<T7, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>>(); foreach(var item in list) dict.Add(item.Item7, item); return dict; }
        public static Dictionary<T8, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> HToDictionaryWithKeyItem8<T1,T2,T3,T4,T5,T6,T7,T8>(this IEnumerable<Tuple<T1,T2,T3,T4,T5,T6,T7,T8>> list) { var dict = new Dictionary<T8, Tuple<T1,T2,T3,T4,T5,T6,T7,T8>>(); foreach(var item in list) dict.Add(item.Item8, item); return dict; }
