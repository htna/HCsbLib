...
namespace HTLib2
{
    ...
    public partial struct HBinaryWriter
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void Write<T1,T2,T3,T4,T5,T6,T7>(Tuple<T1,T2,T3,T4,T5,T6,T7> tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3); _Write(typeof(T4), tuple.Item4); _Write(typeof(T5), tuple.Item5); _Write(typeof(T6), tuple.Item6); _Write(typeof(T7), tuple.Item7); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void Write<T1,T2,T3,T4,T5,T6,T7>(ValueTuple<T1,T2,T3,T4,T5,T6,T7> tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3); _Write(typeof(T4), tuple.Item4); _Write(typeof(T5), tuple.Item5); _Write(typeof(T6), tuple.Item6); _Write(typeof(T7), tuple.Item7); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void Write<T1,T2,T3,T4,T5,T6,T7>(List<Tuple<T1,T2,T3,T4,T5,T6,T7>>  values) { writer.Write(values.Count ); for(int i=0; i<values.Count ; i++) Write(values[i]); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void Write<T1,T2,T3,T4,T5,T6,T7>(     Tuple<T1,T2,T3,T4,T5,T6,T7>[] values) { writer.Write(values.Length); for(int i=0; i<values.Length; i++) Write(values[i]); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void Write<T1,T2,T3,T4,T5,T6,T7>(List<ValueTuple<T1,T2,T3,T4,T5,T6,T7>>  values) { writer.Write(values.Count ); for(int i=0; i<values.Count ; i++) Write(values[i]); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void Write<T1,T2,T3,T4,T5,T6,T7>(     ValueTuple<T1,T2,T3,T4,T5,T6,T7>[] values) { writer.Write(values.Length); for(int i=0; i<values.Length; i++) Write(values[i]); }
    }
}
