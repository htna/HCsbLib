...
namespace HTLib2
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1               >(Tuple<T1               > tuple) { _Write(typeof(T1), tuple.Item1);                                                                                                                                                                      }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2            >(Tuple<T1,T2            > tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2);                                                                                                                                     }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2,T3         >(Tuple<T1,T2,T3         > tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3);                                                                                                    }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2,T3,T4      >(Tuple<T1,T2,T3,T4      > tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3); _Write(typeof(T4), tuple.Item4);                                                                   }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2,T3,T4,T5   >(Tuple<T1,T2,T3,T4,T5   > tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3); _Write(typeof(T4), tuple.Item4); _Write(typeof(T5), tuple.Item5);                                  }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2,T3,T4,T5,T6>(Tuple<T1,T2,T3,T4,T5,T6> tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3); _Write(typeof(T4), tuple.Item4); _Write(typeof(T5), tuple.Item5); _Write(typeof(T6), tuple.Item6); }

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1               >(ValueTuple<T1               > tuple) { _Write(typeof(T1), tuple.Item1);                                                                                                                                                                      }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2            >(ValueTuple<T1,T2            > tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2);                                                                                                                                     }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2,T3         >(ValueTuple<T1,T2,T3         > tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3);                                                                                                    }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2,T3,T4      >(ValueTuple<T1,T2,T3,T4      > tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3); _Write(typeof(T4), tuple.Item4);                                                                   }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2,T3,T4,T5   >(ValueTuple<T1,T2,T3,T4,T5   > tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3); _Write(typeof(T4), tuple.Item4); _Write(typeof(T5), tuple.Item5);                                  }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void HWrite<T1,T2,T3,T4,T5,T6>(ValueTuple<T1,T2,T3,T4,T5,T6> tuple) { _Write(typeof(T1), tuple.Item1); _Write(typeof(T2), tuple.Item2); _Write(typeof(T3), tuple.Item3); _Write(typeof(T4), tuple.Item4); _Write(typeof(T5), tuple.Item5); _Write(typeof(T6), tuple.Item6); }
