...
namespace HTLib2
{
    ...
    public partial struct HBinaryReader
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void Read (out long  [] values) { int length = reader.ReadInt32(); values = new long  [length]; for(int i=0; i<length; i++) values[i] = reader.ReadInt64  (); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public void Read (out List<long  > values) { int length = reader.ReadInt32(); values = new List<long  >(length); for(int i=0; i<length; i++) values.Add(reader.ReadInt64  ()); }
