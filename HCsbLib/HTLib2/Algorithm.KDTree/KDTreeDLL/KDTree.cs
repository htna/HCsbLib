...
namespace KDTreeDLL
{
		...
		where TYPE : class
    {
         ...
         */
        public void insert(double[] key, TYPE value)
        {
        ...
        */
        public TYPE nearest(double[] key)
        {

            TYPE[] nbrs = nearest(key, 1);
            return nbrs[0];
        }
        ...
        */
        ...
        class KDNode
        {
            ...
            public static KDNode ins(HPoint key, TYPE val, KDNode t, int lev, int K)
            {
                if (t == null)
                {
            ...
            private KDNode(HPoint key, TYPE val)
            {
